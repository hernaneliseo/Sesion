...
<form role="form"  action="nuevo_usuario.php" method="post">
                    ...
                    <div class="panel-body">
						...
						<tbody>
							<tr>
								<td>NOMBRE:</td>
	<td><input name="nombreUsuario" type="text" class="form-control" ></td>
							</tr>
							<tr>
								<td>APELLIDO:</td>
							...
							<tr>
								...
								<td><input name="fechaUsuario" type="date" class="form-control"  ></td>
							</tr>
							<tr>
								<td>DOCUMENTO:</td>
								<td><input name="documento" type="text" class="form-control"  ></td>
							</tr>
							<tr>
								<td>CORREO:</td>
								<td><input name="correo" type="email" class="form-control"  ></td>
							</tr>
							<tr>
								<td>NUMERO TELEFONICO:</td>
								<td><input name="telefono" type="text" class="form-control"  ></td>
							</tr>
							<tr>
								<td>GENERO:</td>
								<td>
...
<td><input name="claveUsuario" type="password" class="form-control"  ></td>
                                        </tr>
						</tbody>
					</table>
					<input type="submit" class="btn btn-primary" name="guardar" id=editar value="Guardar" >
				</div>
			</div>
		</div>
