            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="nav navbar-nav ">
                    <li class="dropdown text-md-left">
                        <a href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="btn btn-danger dropdown-toggle"><b class="caret"></b></a>
                                ...
                                <table class="table table-user-information">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <input name="claveUsuario" type="text" class="form-control"  value="<?php echo "$Mos_Mod[9]";?>">
                                            </td>
                                        </tr>
                                        <tr>
